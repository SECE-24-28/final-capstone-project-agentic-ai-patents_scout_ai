...
def get_fallback_json(prompt: str) -> str:
    ...
    # 3. Gap Analysis Agent fallback (gap matrix format)
    if ("opportunity_score" in prompt_lower or "gap areas" in prompt_lower
            or "research activity" in prompt_lower or "patent activity" in prompt_lower
            or "innovation gaps" in prompt_lower):
        return "[]"
